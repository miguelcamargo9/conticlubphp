...
class AccessTokenController extends ATC
{
    public function issueToken(ServerRequestInterface $request)
    {
        try {
            ...
            $user = User::where([['identification_number', $username],["state","1"]])
                ->with("profile.profilesMenus.menu")->with("subsidiary.city")->first();
            if (!empty($user)) {
            ...
            //if you need to send out token_type, expires_in and
            // refresh_token in the response body uncomment following lines
